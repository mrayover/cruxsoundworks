export default function DiscretusDiscernere() {
  return (
    <div className="max-w-6xl mx-auto py-8 flex flex-col md:flex-row gap-8">
      ...
      <div className="w-full md:w-2/3">
        <h1 className="text-3xl font-bold">Discretus & Discernere</h1>
        <p className="mt-1 text-lg italic">String Quartet + Guitar — 2024</p>
